const translations = {
    en: {
        ...
        "nav.home": "Home",
        "nav.about": "About",
        "user.label": "User: Nabila Nurhusna Yap",
        "sidebar.input_config": "INPUT CONFIGURATION",
        "upload.label": "Road Imagery",
        "upload.hint": "JPG/PNG/ZIP, Max 50MB",
        "info.file": "File:",
        "info.size": "Size:",
        ...
        "btn.download_img": "Download Prediction (.png/zip)",
        "btn.download_json": "Download Data (.json/zip)",
        ...
        "btn.close": "Close",
        "eval.title": "Evaluate Test Data",
        "eval.filter": "Filter by Country",
        "btn.back_main": "Back to Main",
        "loading.eval": "Processing evaluation...",
        "eval.select_image": "Select a Test Image for Evaluation",
        "eval.all": "All Images",
        "eval.back_gallery": "Back to Gallery",
        "eval.original": "Original Image",
        "eval.gt": "True Labels (Ground Truth)",
        "eval.baseline": "Prediction: YOLOv11 (Baseline)",
        "eval.sahi": "Prediction: SAHI",
    ...
    id: {
        ...
        "nav.home": "Beranda",
        "nav.about": "Tentang",
        "user.label": "Pengguna: Nabila Nurhusna Yap",
        "sidebar.input_config": "KONFIGURASI INPUT",
        "upload.label": "Citra Jalan",
        "upload.hint": "JPG/PNG/ZIP, Maks 50MB",
        "info.file": "Berkas:",
        "info.size": "Ukuran:",
        ...
        "btn.download_img": "Unduh Prediksi (.png/zip)",
        "btn.download_json": "Unduh Data (.json/zip)",
        ...
        "btn.close": "Tutup",
        "eval.title": "Evaluasi Data Uji",
        "eval.filter": "Saring berdasarkan Negara",
        "btn.back_main": "Kembali ke Utama",
        "loading.eval": "Memproses evaluasi...",
        "eval.select_image": "Pilih Citra Uji untuk Dievaluasi",
        "eval.all": "Semua Citra",
        "eval.back_gallery": "Kembali ke Galeri",
        "eval.original": "Citra Asli",
        "eval.gt": "Label Asli (Ground Truth)",
        "eval.baseline": "Prediksi: YOLOv11 (Baseline)",
        "eval.sahi": "Prediksi: SAHI",
